...
import { FaHeartCircleCheck, FaAward, FaScrewdriverWrench } from "react-icons/fa6";
...
const items = [
  { id: 0, label: "Our Vision", text: "Capitalize on how hanging fruit to identify a ballpark value added activity to beta clickthroughs." },
  { id: 1, label: "Our Mision", text: "Capitalize on how hanging fruit to identify a ballpark value added activity to beta clickthroughs." },
];

const workItems = [
  { id: 0, icon: <FaCalendarPlus size={30} />, title: "Make Appointment", description: "leverage aglie frameworks to provide a robust synopsis for high level overviews.", linkText: "Testimonials" },
  { id: 1, icon: <FaUserTie size={30} />, title: "Consultation", description: "leverage aglie frameworks to provide a robust synopsis for high level overviews.", linkText: "Testimonials" },
  { id: 2, icon: <FaHeartCircleCheck size={30} />, title: "Enjoy The Service", description: "leverage aglie frameworks to provide a robust synopsis for high level overviews.", linkText: "Testimonials" },
];

const statisticItems = [
  { id: 0, icon: <FaAward size={50} />, num: "10+", title: "Years Of Experience", description: "Synopsishigh Level Overviews Value Proposition." },
  { id: 1, icon: <FaSmileBeam size={50} />, num: "5960", title: "Satisfied Client", description: "Synopsishigh Level Overviews Value Proposition." },
  { id: 2, icon: <FaScrewdriverWrench size={50} />, num: "5k", title: "IT Problems Solved", description: "Synopsishigh Level Overviews Value Proposition." },
  { id: 3, icon: <MdAdminPanelSettings size={50} />, num: "25+", title: "Pro Team Members", description: "Synopsishigh Level Overviews Value Proposition." },
];

const expertsItems = [
  { id: 0, srcImage: "/member1.jpg", name: "Hitham Sharo", career: "Managing Director" },
  { id: 1, srcImage: "/member2.jpg", name: "Nattasha Kelvin", career: "Designer" },
  { id: 2, srcImage: "/member3.jpg", name: "Sozi katcha", career: "Marketing Specialist" },
];
    ...
    <section>
        ...
        >
          <div className="xl:w-xl">
            ...
            <div className="flex flex-col gap-3 my-5 items-center justify-center sm:flex-row">
              {items.map((item) => (
                <div key={item.id} className="border-gray-400 border-2 p-3 rounded-2xl">
      ...
      <div className="p-10 xl:my-20 xl:mx-20">
        <div className="flex flex-col justify-center items-center text-center">
          <HeroTitle title="Work Process" description="How We Work" titleSize="text-center" />
        </div>

        <div className="flex flex-col md:flex-row gap-10 mt-10">
          {workItems.map((item) => (
            <div key={item.id} className="relative bg-gray-400 py-8 px-4 rounded-2xl flex flex-col justify-center items-center">
      ...
      <div className="bg-blue-50 grid grid-cols-12 gap-5 px-5 xl:px-20 py-10 justify-items-center">
        {statisticItems.map((item) => (
          <div key={item.id} className="col-span-12 sm:col-span-6 xl:col-span-3 flex flex-col items-center gap-3 pb-5">
      ...
      <div className="py-20 px-5">
        ...
        <div className="flex flex-wrap gap-5 items-center justify-center mt-5">
          {expertsItems.map((item) => (
            <TeamCard key={item.id} srcImage={item.srcImage} name={item.name} career={item.career} />
          ))}
        </div>
      </div>
    </section>
